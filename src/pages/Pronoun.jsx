		...
		<div className="border border-[#1c1c1f] rounded-2xl bg-[#111113] p-7 flex flex-col gap-6 h-full">
			...
			<div className="border-b border-[#1c1c1f] pb-6">
				...
				<div className="flex items-baseline gap-3">
					<span className="text-5xl font-light tracking-[-0.04em] text-[#f59e0b]">
						{pronoun.es.split(" ")[0]}
					</span>
					{pronoun.es.includes("/") && (
						<>
				...
				<p className="text-[13px] text-[#52525b] mt-2">{pronoun.en}</p>
			</div>

			{/* Metadata */}
			<div className="flex gap-3">
				{[
					{ label: "Person", val: pronoun.person },
					{ label: "Number", val: pronoun.number },
				].map((m) => (
					<div
						key={m.label}
			...
			<div className="max-w-5xl mx-auto px-8 pt-24 pb-20">
				...
				<div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 items-start">
					...
					<div className="lg:sticky lg:top-8">
						<DetailPanel pronoun={activeData} />
					</div>
				</div>
